...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1/"; // Change
																			...
																			// API
																			// URL
	public static final String REST_CONSUMER_KEY = "XisTYf2K56alRjBD9U2Kpw"; // Change
																				// this
	public static final String REST_CONSUMER_SECRET = "CIixNLolQgUhLZCNpX6YKts5Qi5nUr4nD6Z8RMmtoo"; // Change
																									// this
	...
	public void getFollowing(String name, AsyncHttpResponseHandler handler) {
	...
	public void getFollowers(String name, AsyncHttpResponseHandler handler) {
	...
	public void getOtherUsersTimeline(String name,
	...
	public void getAdditionalOtherUsersTimeline(String name, Long id,
			AsyncHttpResponseHandler handler) {
	...
	public void getAdditionalUserTimeline(Long id,
			AsyncHttpResponseHandler handler) {
